...
function preload(){
	...
	game.load.image('images','assets/images.png');
...
//	game.load.onLoadStart.add(loadStart, this);
  ...
  //  game.stage.scale.startFullScreen();
   ...
   //Add Explosion object pool
	...
	game.add.text(3330,h-280,"Class 10th \n 9.6/10.0 CGPA \n Class Topper", style);
	...
	game.add.sprite(10910,h-268,'sandiskLogo');
	...
	game.add.text(12210,h-470,"Developed An Android App - Twilight Scans\n 5000+ Downloads on playstore\n An app for free Mangas",style_white);
	...
	game.add.text(13300,h-430,"Developed Machine learning model, \n took datasets from Promise repository\n to ensure Software Quality Assurance.",style_white);
	...
	t.start();
	game.add.text(14240,h-385,"Worked in a team \nto Develop an android application to help \n in providing assistance in case \nof vehicle breakdown/emergy situation.",style_white);
	...
	game.add.text(base5+505,h-300,"Won several District Level\n poster making\n & \n Quiz Competitions. ",style_white);
	...
	game.add.sprite(base6+640,h-240,'hackerearthLogo');
	game.add.text(base6+600,h-330,"Host: \nEntrepreneurship Cell \n workshop",style_white);
...
*/
	...
	var clg = game.add.sprite(3940,h-355,'dtu');
...
//	hero.body.gravity.y=10000;
	...
	game.add.text(w-120,100,"Download Resume",{font:"10px Roboto",fill:"#000"}).fixedToCamera=true;
...
function openGmail(){
 var win = window.open("mailto:sa7495@nyu.edu");
 win.focus();
}
...
function openPublication(){
 var win = window.open("https://drive.google.com/file/d/1D1QbSXjkAmSgcZsPwHPnoKr1Fkd8VDkb/view?usp=sharing");
 win.focus();
}
